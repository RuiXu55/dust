...
double Gsize,Gnr,Gm,Gmr,Gr,Nu0,Ed,ngr,nlayer;
...
while (time<Evo_time){
  ...
  for (int j=1;j<Num-1;j++){
    ...
    ngr = N_h[0]*Grain[i].fd[j]*1.673e-24*2.34/
      (4.0/3.0*3.1415926*2.0*pow(Grain[i].size/1.e4,3));
    maxman = msiteden*ngr;
